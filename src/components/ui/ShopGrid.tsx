...
export default function ShopGrid({ data }: TanksDataApiResponse) {
  ...
  return (
    <motion.div
      layout="position"
      className="grid items-center text-[#FEFEEC] grid-cols-[repeat(auto-fill,minmax(250px,1fr))] gap-5 md:grid-cols-[repeat(auto-fill,minmax(300px,1fr))] lg:grid-cols-[repeat(auto-fill,minmax(400px,1fr))]"
    >
      <AnimatePresence>
